...
(function() {
    ...
    LC.LiterallyCanvas = function() {
        ...
        LiterallyCanvas.prototype.zoom = function(factor) {
            ...
            this.opts.updateZoom(this.scale);
        ...
        LiterallyCanvas.prototype.repaint = function(dirty, drawBackground) {
            ...
            if (this.backgroundImage) drawBackground = true;
            if (dirty) {
                ...
                if (drawBackground) {
                    ...
                    if(this.backgroundImage) {
                        var viewportW = 100*this.scale;
                        var viewportH = 50*this.scale;
                        this.bufferCtx.drawImage(
                            this.backgroundImage,
                            (this.canvas.width - viewportW)/2,
                            (this.canvas.height - viewportH)/2,
                            viewportW,
                            viewportH);
                    }
                }
...
(function() {
    var _ref;
    window.LC = (_ref = window.LC) != null ? _ref : {};
    LC.toolbarHTML = '  <div class="toolbar-row">    <div class="toolbar-row-left">      <div class="tools button-group"></div>      <div class="color-square background-picker" style="display:none">&nbsp;</div>  &nbsp;&nbsp;Фон: <input type=file  size=20 name=file id="file-input">  </div>    <div class="toolbar-row-right">      <div class="action-buttons">        <div class="button clear-button danger">Очистить</div>        <div class="button-group">          <div class="button btn-warning undo-button">&larr;</div><div class="button btn-warning redo-button">&rarr;</div>        </div>        <div class="button-group">          <div class="button btn-inverse zoom-button zoom1-button active">1:1</div><div class="button btn-inverse zoom-button zoom2-button">2:1</div><div class="button btn-inverse zoom-button zoom4-button">4:1</div>        </div>             </div>    </div>    <div class="clearfix"></div>  </div>  <div class="toolbar-row">   <div class="toolbar-row-left"> <div style="float:left">&nbsp;Цвет: &nbsp; </div>   <div class="color-square primary-picker"></div>      <div class="color-square secondary-picker" style="display:none"></div>   <div style="float:left">&nbsp;&nbsp;Размер: &nbsp; </div>    <div class="tool-options-container"></div>    </div>    <div class="clearfix"></div>  </div>';
    ...
    LC.Toolbar = function() {
        ...
        Toolbar.prototype.initZoom = function() {
            var _this = this;
            this.$el.find(".zoom1-button").click(function(e) {
                _this.$el.find(".zoom-button").removeClass('active');
                $(this).addClass('active');
                _this.lc.zoom(1);
            });
            this.$el.find(".zoom2-button").click(function(e) {
                _this.$el.find(".zoom-button").removeClass('active');
                $(this).addClass('active');
                _this.lc.zoom(2);
            });
            return this.$el.find(".zoom4-button").click(function(e) {
                _this.$el.find(".zoom-button").removeClass('active');
                $(this).addClass('active');
                _this.lc.zoom(4);
            });
...
(function() {
    ...
    LC.StrokeWidget = function(_super) {
        ...
        StrokeWidget.prototype.options = function() {
            ...
            $el = $("      <span class='brush-width-min' style='display:none'>1 px</span>      <input type='range' min='1' max='20' step='1' value='" + this.tool.strokeWidth + "'>      <span class='brush-width-max' style='display:none'>50 px</span>      <span class='brush-width-val' style='display:none'>(5 px)</span>    ");
